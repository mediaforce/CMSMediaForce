 ...
 */
class ArquivoTexto extends \CmsMediaForce\Entity\ArquivoTexto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'descricao', 'endereco', 'dadosCad');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ArquivoTexto $proxy) {
    ...
    public function getDadosCad()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDadosCad', array());

        return parent::getDadosCad();
    }
    ...
    public function setDadosCad($dadosCad)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDadosCad', array($dadosCad));

        return parent::setDadosCad($dadosCad);
    }
